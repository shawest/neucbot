...
the nuclear reaction database generated by TALYS-1.6 [\[0\]](#0). By 
...
NeuCBOT uses a SRIM-generated [\[1\]](#1) stopping power database
...
data for these isotopes from the ENSDF [\[2\]](#2) database and 
...
* ./Data/abundances.dat : Natural abundances of every isotope, from [\[3\]](#3)
...
natural abundances, as reported in [\[3\]](#3).
...
----------------------------------------------------------
0. <a name="0">A. Koning, et al. TALYS-1.6. http://www.talys.eu/</a>
1. <a name="1">J. Ziegler, et al. SRIM-2008. http://www.srim.org/</a>
2. <a name="2">J. K. Tuli, et al. Evaluated Nuclear Structure Data File (ENSDF), 1996.</a>
3. <a name="3">P. De Bievre and P.D.P. Taylor, Int. J. Mass Spectrom. Ion Phys. 123, 149 (1993).</a>